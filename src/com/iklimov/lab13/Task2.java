...
class Task2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            addDepartmentSafely(departments, "Department 1", new Employee("Steven", "Jones", 1251), departmentOneEmployees);
    ...
    private static void addDepartmentSafely(List<Department> departments, String title, Employee head, List<Employee> employees) throws WrongDepartmentDataException {
        if (title == null || title.isEmpty()) {
            throw new WrongDepartmentDataException("Wrong department title is used: " + title);
        } else if (head == null) {
            throw new WrongDepartmentDataException("Missing department's head");
        } else if (employees == null || employees.isEmpty()) {
            throw new RuntimeException("Missing employee list");
        }

        departments.add(new Department(title, head, employees));
    }
